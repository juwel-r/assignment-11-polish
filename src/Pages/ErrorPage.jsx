...
import notFoundAnimation from "../assets/aniamtion_json/notFoundAnimation.json";
...
const ErrorPage = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-blue-50 to-cyan-50">
      ...
      <Link
        to="/"
        className="px-6 py-3 text-white font-medium rounded-lg shadow-md bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-cyan-600 hover:to-blue-600 transform transition-all duration-300"
      >
        Go Back Home
      </Link>
    </div>
