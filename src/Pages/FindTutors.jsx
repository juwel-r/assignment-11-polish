  ...
  return (
    <div className="md:w-11/12 mx-auto w-[95%]">
      <div className="text-center">
        <h1 className="md:w-8/12 mx-auto text-2xl md:text-4xl font-semibold">Find Your Perfect Tutor</h1>
        <p className="md:w-11/12 mx-auto md:my-6 my-4 text-sm md:text-base">
